...
var displayDataOnPage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var dataCoord, weatherData, hourlyWeather;
  ...
  return function displayDataOnPage(_x) {
...
function displayHourlyWeather(hourlyWeather) {
  ...
  hourlyWeather.forEach(function (item) {
    ...
    if (dateForToday === currentDate) {
      ...
      var _hourlyWeather = document.querySelector(".day-weather-byHours");
      _hourlyWeather.append(divHour);
    }
  });
}
...
document.querySelector("form").addEventListener("submit", _dom__WEBPACK_IMPORTED_MODULE_1__.displayDataOnPage);
